...
static const sl_cli_command_info_t cli_cmd_peoplecount_increase = \
  SL_CLI_COMMAND(people_count_increase_from_cli,
                 "Increasing people count sensor value.",
                  "",
                 {SL_CLI_ARG_END, });

static const sl_cli_command_info_t cli_cmd_peoplecount_decrease = \
  SL_CLI_COMMAND(people_count_decrease_from_cli,
                 "Decreasing people count sensor value.",
                  "",
                 {SL_CLI_ARG_END, });

static const sl_cli_command_info_t cli_cmd_peoplecount_set = \
  SL_CLI_COMMAND(people_count_set_from_cli,
                 "Set people count sensor value",
                  "People count sensor value" SL_CLI_UNIT_SEPARATOR,
                 {SL_CLI_ARG_UINT16, SL_CLI_ARG_END, });

static const sl_cli_command_info_t cli_cmd_peoplecount_get = \
  SL_CLI_COMMAND(people_count_get_from_cli,
                 "Get people count sensor value",
                  "",
                 {SL_CLI_ARG_END, });
...
static const sl_cli_command_entry_t peoplecount_group_table[] = {
  { "increase", &cli_cmd_peoplecount_increase, false },
  { "i", &cli_cmd_peoplecount_increase, true },
  { "decrease", &cli_cmd_peoplecount_decrease, false },
  { "d", &cli_cmd_peoplecount_decrease, true },
  { "set", &cli_cmd_peoplecount_set, false },
  { "s", &cli_cmd_peoplecount_set, true },
  { "get", &cli_cmd_peoplecount_get, false },
  { "g", &cli_cmd_peoplecount_get, true },
  { NULL, NULL, false },
};
static const sl_cli_command_info_t cli_cmd_grp_peoplecount = \
  SL_CLI_COMMAND_GROUP(peoplecount_group_table, "Controlling people count sensor value.");
...
const sl_cli_command_entry_t sl_cli_default_command_table[] = {
  ...
  { "peoplecount", &cli_cmd_grp_peoplecount, false },
  { "pc", &cli_cmd_grp_peoplecount, true },
  { NULL, NULL, false },
};
